...
import fallsand.data.main.ui.GuiIngameHook;

public class Minecraft implements IThreadListener, IPlayerUsage
{
    private static final Logger logger = LogManager.getLogger();
    private static final ResourceLocation locationMojangPng = new ResourceLocation("fallsand/FallSand_Load.png");
    ...
    private void func_175609_am() throws LWJGLException
    {
        ...
        Display.setTitle(FallSand.Client_Name + "-rel-" + FallSand.Client_Version);
